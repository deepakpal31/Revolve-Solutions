...
def get_params() -> dict:
    ...
    parser.add_argument('--customers_location',  required=False, default="/home/deepak/Downloads/python-assignment-level2/input_datastarter/customers.csv")

    parser.add_argument('--products_location', required=False, default="/home/deepak/Downloads/python-assignment-level2/input_datastarter/products.csv")
    parser.add_argument('--transactions_location', required=False, default="/home/deepak/Downloads/python-assignment-level2/input_datastarter/transactions/")

    parser.add_argument('--output_location', required=False, default="/home/deepak/Downloads/python-assignment-level2/output_data/")
